...
safety_judge_agent = llm_agent.LlmAgent(
    model="gemini-2.5-flash-lite", # Using gemini-2.5-flash-lite to match the available model in this environment
    name="safety_judge",
        ...
        *,
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="I apologize, but I cannot provide that information due to safety and security policies.")],
                )
